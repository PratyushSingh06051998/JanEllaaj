...
public class SelectTYpeActivity extends AppCompatActivity implements View.OnClickListener, GoogleApiClient.OnConnectionFailedListener {
    ...
    private TextView headertitel, headersubtitle, codeTextView, doctor, pharmacy, different, pathlab, iam;
    ...
    public void iniView() {
        ...
        this.pharmacy = this.findViewById(R.id.were_a_pharmacy);
