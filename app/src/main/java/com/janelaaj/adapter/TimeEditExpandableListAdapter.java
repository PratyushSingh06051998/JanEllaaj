...
public class TimeEditExpandableListAdapter extends BaseExpandableListAdapter{
    ...
    public TimeEditExpandableListAdapter(Context context, List<String> listDataHeader, HashMap<String, List<String>> listChildData,ArrayList<String> Mon,ArrayList<String> Tue,ArrayList<String> Wed,ArrayList<String> Thu,ArrayList<String> Fri,ArrayList<String> Sat,ArrayList<String> Sun,String id) {
                ...
                if(preferences.contains("fromtime"+pos+id) && preferences.contains("totime"+pos+id))
                    {
                        ...
                        if(mon.equals("0"))
                        {
                            if(Integer.parseInt(fromtime) > Integer.parseInt(totime)) {
                                ...
                                {
                                    Log.i("time",String.valueOf(Mon.size()));

                                    Log.i("time","All time " + Mon.get(i));
                                    ...
                                    if(Integer.parseInt(fromtime) > Integer.parseInt(from) && Integer.parseInt(totime) > Integer.parseInt(to))
                                    {
                                         flag+=1;
                                         Log.i("time","first loop mein");
//                                        Log.i("time","in first loop ");
//                                        Mon.add(total);
...
//                                        editor.commit();
                                    ...
                                    else if(Integer.parseInt(totime) < Integer.parseInt(from) && Integer.parseInt(fromtime) < Integer.parseInt(to))
                                    {
                                        flag+=1;
                                        Log.i("time","second loop mein");
//                                        Mon.add(total);
//                                        Log.i("time","in second loop");
//                                        SharedPreferences.Editor editor = preferences.edit();
//                                        monday.setBackgroundResource(R.drawable.circle_bg2);
//                                        editor.putString("m" + pos + id, "1");
//                                        editor.putString("total" + pos + id, total);
